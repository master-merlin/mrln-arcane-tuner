...
`v0.5.1-alpha` · PyTorch 2.10 · CUDA 13.0 · Angular 22 · Node 24 · FastAPI
...
mastermerlin/mrln-arcane-tuner:0.5.1-alpha     # pinned version
```
...
docker build -t mastermerlin/mrln-arcane-tuner:0.5.1-alpha -t mastermerlin/mrln-arcane-tuner:latest .
docker push mastermerlin/mrln-arcane-tuner:0.5.1-alpha
