...
# Source: omnigen2/models/transformers/block_lumina2.py
# Apache-2.0 — vendored for the omnigen2 family (local diffusers 0.39.0).
#
# MRLN-PATCH: triton fused RMSNorm and flash-attn fused swiglu removed —
# torch.nn.RMSNorm and components.swiglu are upstream's own fallback
# branches when triton/flash-attn are unavailable.
