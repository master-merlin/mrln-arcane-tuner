...
| File            | Purpose                                                        |
| --------------- | -------------------------------------------------------------- |
| `main.py`       | FastAPI app, lifespan, middleware, CORS, router mounts, static |
...
| `analysis_routes.py`    | analysis, bump, harmonize                                  | Dataset analysis + duplicate det |
...
| Module                  | Routes                                                       | Purpose                      |
| ----------------------- | ------------------------------------------------------------ | ---------------------------- |
| `job_routes.py`         | jobs CRUD, start/stop/pause/resume/soft-stop/restart, logs   | Job lifecycle                |
...
| `dynamic-form-field`           | Single configurable field (input, select, etc.)  |
