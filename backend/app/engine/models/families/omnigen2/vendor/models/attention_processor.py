...
# Source: omnigen2/models/attention_processor.py
# Apache-2.0 — vendored for the omnigen2 family (local diffusers 0.39.0).
#
# MRLN-PATCH: OmniGen2AttnProcessorFlash2Varlen and all flash_attn imports
# removed — flash-attn is not a dependency of this repo, and the SDPA
# OmniGen2AttnProcessor below is upstream's own documented fallback (their
# OmniGen2TransformerBlock.__init__ catches the Flash2Varlen ImportError
# and constructs this class instead).
"""
