...
@Component({
    ...
    template: `
        <span class="state-pills">
            <span class="state-pill H" data-testid="state-pill-harmonized"
            ...
            <span class="state-pill C" data-testid="state-pill-captioned"
            ...
            <span class="state-pill M" data-testid="state-pill-masked"
